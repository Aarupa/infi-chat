...
//       icon: <CustomerServiceOutlined style={{ fontSize: '32px', color: '#6a0dad' }} />,
...
//             Welcome to <span style={{ color: '#8a2be2' }}>Infi-Chat</span>
//           </Title>
...
//         {/* Mission & Vision */}
//         <Divider orientation="center" style={{ color: '#fff', fontSize: '24px' }}>Our Purpose</Divider>
//         <Row gutter={[40, 40]} style={{ margin: '60px 0' }}>
//           <Col xs={24} md={12}>
//             <Card
//               bordered={false}
//               style={{ background: 'rgba(106, 13, 173, 0.1)', height: '100%' }}
//               bodyStyle={{ padding: '30px' }}
//             >
//               <Title level={3} style={{ color: '#8a2be2' }}>Our Vision</Title>
...
//               bodyStyle={{ padding: '30px' }}
//             >
//               <Title level={3} style={{ color: '#8a2be2' }}>Our Mission</Title>
//               <Paragraph style={{ fontSize: '16px' }}>
...
//         {/* Services */}
//         <Divider orientation="center" style={{ color: '#fff', fontSize: '24px' }}>Our Services</Divider>
...
//                 <Paragraph style={{ color: '#aaa' }}>{service.description}</Paragraph>
//               </Card>
//             </Col>
//           ))}
//         </Row>
